...
func RegisterHeartbeatAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server HeartbeatAPIServer) error {
	...
	mux.Handle("POST", pattern_HeartbeatAPI_CheckLive_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_HeartbeatAPI_CheckLive_0(rctx, inboundMarshaler, server, req, pathParams)
	...
	mux.Handle("POST", pattern_HeartbeatAPI_CheckReady_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_HeartbeatAPI_CheckReady_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
...
// RegisterHeartbeatAPIHandler registers the http handlers for service HeartbeatAPI to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterHeartbeatAPIHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterHeartbeatAPIHandlerClient(ctx, mux, NewHeartbeatAPIClient(conn))
}

// RegisterHeartbeatAPIHandlerClient registers the http handlers for service HeartbeatAPI
...
func RegisterHeartbeatAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client HeartbeatAPIClient) error {
	...
	mux.Handle("POST", pattern_HeartbeatAPI_CheckLive_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_HeartbeatAPI_CheckLive_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_HeartbeatAPI_CheckReady_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_HeartbeatAPI_CheckReady_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
